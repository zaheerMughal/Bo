...
public class DepositMoney extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            amountET.setText(String.valueOf(savedInstanceState.getLong(KEY_INSTANCE_STATE_AMOUNT)));
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putLong(KEY_INSTANCE_STATE_AMOUNT,getEnteredAmount());
    }
    ...
    private long getEnteredAmount() {
        ...
        {
            return Long.parseLong(amountET.getText().toString());
        }

    }

    private void depositAmount(long amount) {
        ...
        if(cursor!=null)
        {
            if(cursor.moveToFirst())
            {
                previousAmount = cursor.getLong(cursor.getColumnIndex(DbContract.GOALS.COLUMN_DEPOSITED_AMOUNT));
