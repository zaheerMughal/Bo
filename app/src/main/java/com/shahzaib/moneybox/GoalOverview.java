                ...
                ExecutorSupplier.getInstance().forBackgroundTasks().execute(new Runnable() {
                    ...
                    Handler handler = new Handler(Looper.getMainLooper())
                    {
                        ...
                        public void handleMessage(Message msg) {
                            ...
                            targetAmountTV.setText(Goal.separateNumberWithComma(goal.getTargetAmount()));
                            depositedAmountTV.setText(Goal.separateNumberWithComma(goal.getDepositedAmount()));
                            remainingAmountTV.setText(Goal.separateNumberWithComma(goal.getRemainingAmount()));
